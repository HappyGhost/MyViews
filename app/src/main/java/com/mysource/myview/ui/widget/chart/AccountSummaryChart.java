...
public class AccountSummaryChart extends View {
    ...
    public AccountSummaryChart(Context context) {
        this(context, null);
    }

    public AccountSummaryChart(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AccountSummaryChart(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        mTouchPointPaint.setColor(0xffffffff);
    ...
    private void drawChartItemModel(Canvas canvas) {
        ...
        if (chartPath != null) {
            ...
            if (touchX != -1 && !label.equals("-1")) {
                ...
                mTouchPointPaint.setColor(0xff008fd5);
